...
import 'package:sanadi/features/medications/viewmodel/medication_cubit.dart';
        ...
        return BlocConsumer<AuthCubit, AuthState>(
          listener: (context, state) {
            if (state is AuthSuccess) {
              // ✅ تحميل الأدوية فوراً عند تسجيل الدخول الناجح
    ...
    return Row(
      ...
      children: [
        Text(
          'auth.no_account'.tr(),
          style: TextStyle(
              fontSize: isDesktop ? 14 : 14.sp, color: AppColors.textSecondary),
        ),
        TextButton(
          onPressed: () {
            Navigator.push(
